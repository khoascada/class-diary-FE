...
const AdminDashboard = () => {
                ...
                <div className="border rounded-lg p-4 max-h-96 overflow-y-auto">
                  {Object.entries(grouped).map(([category, perms]) => (
                    <div key={category} className="mb-4">
                      <h4 className="text-sm font-semibold text-gray-700 mb-2 bg-gray-100 px-2 py-1 rounded">
                        {category}
                      </h4>
                      {perms.map((perm) => (
                        <div
  ...
  const renderUserRoleAssignment = () => (
    <div className="grid grid-cols-2 gap-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Gán Vai Trò</h2>
        ...
        {selectedUser ? (
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4">
                <button className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="w-64 bg-gray-900 text-white flex flex-col">
        <div className="p-6 border-b border-gray-700">
          ...
          <p className="text-xs text-gray-400 mt-1">Quản Lý Sổ Đầu Bài</p>
        </div>
